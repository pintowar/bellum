...
import io.github.pintowar.bellum.solver.timefold.TimefoldScheduler
import io.kotest.core.spec.style.FunSpec
import io.kotest.matchers.shouldBe
import io.kotest.matchers.shouldNotBe
import kotlin.time.Duration.Companion.seconds

class TimefoldSchedulerTest :
    FunSpec({

        test("successful solve") {
            val solver = TimefoldScheduler(DataFixtures.smallTimeEstimator)
            ...
            scheduledProject.endsAt() shouldNotBe null
        }
