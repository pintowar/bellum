...
import io.github.pintowar.bellum.parser.json.JsonEmployeeDto
import io.github.pintowar.bellum.parser.json.JsonProjectDto
import io.github.pintowar.bellum.parser.json.JsonTaskDto
import kotlinx.serialization.encodeToString
import kotlinx.serialization.json.Json

class RtsToJsonConverter : BaseConverter<ParsedProject, String>() {
    companion object {
        private val json =
            Json {
                prettyPrint = true
    ...
    override fun doConvert(input: ParsedProject): String {
